...
def dtest_range_intersects(self):
    s = AntVisionSequence(self.data_paths, self.batch_size, self.bot_to_emulate)
...
def dtest_get_batch_across_index(self):
    s = AntVisionSequence(self.data_paths, self.batch_size, self.bot_to_emulate)
    s.build_indexes()
